...
// DOM - here is where we select if we are using CPU or GPU.
// I have selected CPU, but it should work for both.
// to change just swap the comments around - but remember that if you 
// do change this, you must "make clean".
