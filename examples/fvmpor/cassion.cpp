...
namespace fvmpor{
    ...
    void VarSatPhysicsImpl<TVec>::set_initial_conditions( double &t, const mesh::Mesh& m ){
    ...
    // set physical zones
    template <typename TVec>
    void VarSatPhysicsImpl<TVec>::set_physical_zones( void )
    {
    ...
    template <typename TVec>
    void VarSatPhysicsImpl<TVec>::set_constants(){
    ...
    // boundary conditions
    template <typename TVec>
    void VarSatPhysicsImpl<TVec>::set_boundary_conditions(){
        // no flow boundaries
